# 말리와 임금님 귀는 당나귀 귀 — 썸네일 배경 생성 (좌측 1/3 비움, 글자는 ffmpeg drawtext 후합성)
# 지브리 스타일 고정: STYLE 단일 출처 + 스타일 앵커 첨부 (2026-07-12 필수화)
# 가로(16:9) 강제 — 세로 드리프트 발생 시 재실행 (2026-07-16 까치편 교훈)
import base64
import sys
import time
...
PROMPT = (
    ...
    f"YouTube thumbnail background for a children's storybook video: {MALLI} gazing with big surprised sparkling eyes "
    "at a kind Korean king in an ornate red-and-gold royal robe who has just lifted his tall headband to reveal big "
    "fuzzy DONKEY-LIKE ears on his head, standing in a bright elegant Korean palace courtyard, funny surprising wondrous mood, "
    "positioned on the RIGHT TWO THIRDS of the frame, bright cheerful colors with strong contrast, "
    "composition leaves the LEFT THIRD of the image relatively simple and soft (plain warm background) for large text overlay, "
