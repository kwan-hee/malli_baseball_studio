# 말리와 임금님 귀는 당나귀 귀 - 절정 씬(s07 대나무숲이 비밀을 노래, s09 임금님이 귀를 드러냄) 이미지→영상 클립 생성기
...
CLIP_PROMPTS = {
    "s07": (
        "A deep green bamboo grove at daytime; a gentle gust of wind sweeps through and the tall slender bamboo "
        "stalks bend and sway together as if whispering and singing a secret, leaves drifting through soft sunbeams, "
        "a magical hush over the grove. "
        f"Wondrous, mysterious, gentle. {GHIBLI}"
    ),
    "s09": (
        "In a sunny Korean palace courtyard, a kind Korean king in an ornate red-and-gold robe bravely takes off "
        "his tall headband to reveal big fuzzy donkey-like ears, smiling with relief, while happy townspeople around "
        "him smile and cheer warmly and kindly (not mocking). "
        f"Heartwarming, joyful, freeing. {GHIBLI}"
    ),
}
