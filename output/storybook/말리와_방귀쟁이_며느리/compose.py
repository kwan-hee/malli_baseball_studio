# 말리와 방귀쟁이 며느리 — 최종 조립: 이미지 Ken Burns + 절정 클립 + 나레이션 + 자막 + BGM → MP4
...
VIDEO_SCENES = {
    "s06": BASE / "clips" / "s06_1080p.mp4",  # 어마어마한 방귀로 온 집안이 들썩
    "s09": BASE / "clips" / "s09_1080p.mp4",  # 방귀로 배가 우수수 떨어짐
}
...
final = BASE / "✅말리와_방귀쟁이_며느리_final.mp4"  # ✅ 접두 = 폴더에서 완성본 즉시 구분
