# 말리와 방귀쟁이 며느리 - 절정 씬(s06 방귀로 온 집안이 들썩, s09 방귀로 배가 우수수) 이미지→영상 클립 생성기
...
CLIP_PROMPTS = {
    "s06": (
        "Inside a cozy Korean hanok, a mighty comical gust of wind suddenly blasts through the house: paper sliding "
        "doors fling open, a heavy iron cauldron lid spins up into the air, and the family members cling to wooden "
        "pillars fluttering like flags in the wind, the young bride at the center, everything shaking. "
        f"Wildly funny, chaotic, comical, NOT scary. {GHIBLI}"
    ),
    "s09": (
        "In a Korean village a young bride in hanbok faces a very tall pear tree; a strong gust of wind shakes the "
        "tree and ripe golden pears rain down all at once as delighted villagers below cheer and catch them with "
        "open arms. "
        f"Joyful, triumphant, funny, lively. {GHIBLI}"
    ),
}
