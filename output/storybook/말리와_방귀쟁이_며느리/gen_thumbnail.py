# 말리와 방귀쟁이 며느리 — 썸네일 배경 생성 (좌측 1/3 비움, 글자는 ffmpeg drawtext 후합성)
...
PROMPT = (
    ...
    f"YouTube thumbnail background for a children's storybook video: {MALLI} gazing with big surprised delighted eyes "
    "at a young Korean bride in a pretty pink-and-green hanbok whose mighty comical fart-gust of wind sends golden pears raining down from a tall pear tree while a family clings to pillars and a cauldron lid spins in the air, wildly funny joyful mood, "
