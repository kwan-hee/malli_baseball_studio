# 말리와 금도끼 은도끼 — 최종 조립: 이미지 Ken Burns + 절정 클립 + 나레이션 + 자막 + BGM → MP4
import subprocess
...
VIDEO_SCENES = {
    "s04": BASE / "clips" / "s04_1080p.mp4",  # 연못 할아버지 등장
    "s07": BASE / "clips" / "s07_1080p.mp4",  # 욕심쟁이 일부러 퐁당
}
...
final = BASE / "말리와_금도끼_은도끼_final.mp4"
