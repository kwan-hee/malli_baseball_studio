# 말리와 금도끼 은도끼 - 절정 씬(s04 할아버지 등장, s07 욕심쟁이 퐁당) 이미지→영상 클립 생성기
...
CLIP_PROMPTS = {
    "s04": (
        "The emerald pond water gently parts and glows as a mysterious kind grandfather spirit with a long "
        "flowing white beard rises gracefully from the water holding up a shining golden axe, mist drifting, "
        "light rays shimmering, while the young woodcutter kneeling at the pond edge looks up in awe. "
        f"Magical, gentle, wondrous. {GHIBLI}"
    ),
    "s07": (
        "The plump greedy woodcutter winds up comically and deliberately hurls his own axe high into the "
        "emerald pond, the axe spins through the air and lands with a big cartoon splash and ripple rings, "
        "he rubs his hands with a sneaky grin while a little squirrel on a branch shakes its head. "
        f"Comedic, mischievous, playful. {GHIBLI}"
    ),
}
