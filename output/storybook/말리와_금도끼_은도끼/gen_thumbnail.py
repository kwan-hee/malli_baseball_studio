# 말리와 금도끼 은도끼 — 썸네일 배경 생성 (좌측 1/3 비움, 글자는 ffmpeg drawtext 후합성)
...
PROMPT = (
    ...
    "next to a mysterious kind grandfather spirit with a long flowing white beard rising from a glowing emerald pond "
    "holding up a shining golden axe, a young woodcutter in hanbok gazing up in awe from the mossy pond edge, "
    "magical glittering light on the water, wondrous and heartwarming scene, positioned on the RIGHT TWO THIRDS of the frame, "
