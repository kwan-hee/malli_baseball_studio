# 말리와 커다란 순무 — 썸네일 배경 생성 (좌측 1/3 비움, 글자는 ffmpeg drawtext 후합성)
import base64
import sys
import time
...
PROMPT = (
    ...
    f"YouTube thumbnail background for a children's storybook video: {MALLI}, "
    "pulling the leaves of a gigantic turnip (round white body with purple top, huge green leaves) "
    "with all her might, cheeks puffed with effort, cute and funny, positioned on the RIGHT TWO THIRDS "
    "of the frame, bright cheerful colors with strong contrast, "
    "composition leaves the LEFT THIRD of the image relatively simple and soft (plain sky or field) for large text overlay, "
    "Studio Ghibli anime style, soft painterly, warm pastel colors, no text, no letters. "
