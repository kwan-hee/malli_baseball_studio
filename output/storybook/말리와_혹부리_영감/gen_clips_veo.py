# 말리와 혹부리 영감 - 절정 씬(s04 도깨비 등장, s06 혹 떼감·보물) 이미지→영상 클립 생성기
...
CLIP_PROMPTS = {
    "s04": (
        "Inside a warm candlelit old Korean thatched hut at night, a kind old grandfather with a lump on his "
        "cheek sings happily, and a whole crowd of friendly comical Korean goblins (dokkaebi) with one horn and "
        "goofy grins come tumbling and crowding in through the door and windows, clapping and bouncing along to "
        "his song, delighted and playful. "
        f"Lively, funny, joyful, NOT scary. {GHIBLI}"
    ),
    "s06": (
        "Inside the candlelit hut, the crowd of friendly Korean goblins joyfully push glittering piles of gold "
        "and treasure toward the delighted old grandfather, while one goblin gently lifts the round lump away "
        "from the old man's cheek like a magic trick, sparkles floating in the air, the grandfather amazed and "
        "happy. "
        f"Wondrous, warm, funny, magical. {GHIBLI}"
    ),
}
