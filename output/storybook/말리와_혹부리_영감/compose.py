# 말리와 혹부리 영감 — 최종 조립: 이미지 Ken Burns + 절정 클립 + 나레이션 + 자막 + BGM → MP4
...
VIDEO_SCENES = {
    "s04": BASE / "clips" / "s04_1080p.mp4",  # 도깨비 우르르 등장
    "s06": BASE / "clips" / "s06_1080p.mp4",  # 혹 떼감 + 보물
}
...
final = BASE / "말리와_혹부리_영감_final.mp4"
