# 말리와 견우와 직녀 - 절정 씬(s07 오작교 형성, s08 오작교 재회) 이미지→영상 클립 생성기
...
CLIP_PROMPTS = {
    "s07": (
        "A huge flock of magpies and crows sweeps gracefully in from both sides of the starry night sky, "
        "wings linking together one by one to form a long glowing bridge arching over the glittering Milky Way, "
        "feathers shimmering with starlight as the young cowherd and the weaver girl in hanbok step onto "
        "each end of the bird bridge from opposite banks. "
        f"Wondrous, magical, spectacular. {GHIBLI}"
    ),
    "s08": (
        "On the glowing bridge of magpies and crows arching over the Milky Way, the young cowherd and the "
        "weaver girl in hanbok run toward each other from opposite ends with arms outstretched and joyful "
        "tearful smiles, meeting in the middle in a warm embrace as stars swirl and twinkle in celebration "
        "around them. "
        f"Joyful, tender, reunion climax. {GHIBLI}"
    ),
}
