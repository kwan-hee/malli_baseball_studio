# 말리와 견우와 직녀 — 최종 조립: 이미지 Ken Burns + 절정 클립 + 나레이션 + 자막 + BGM → MP4
...
VIDEO_SCENES = {
    "s07": BASE / "clips" / "s07_1080p.mp4",  # 까치·까마귀 오작교 형성
    "s08": BASE / "clips" / "s08_1080p.mp4",  # 오작교 재회
}
...
final = BASE / "말리와_견우와_직녀_final.mp4"
