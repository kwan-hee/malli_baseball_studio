# 말리와 견우와 직녀 — 썸네일 배경 생성 (좌측 1/3 비움, 글자는 ffmpeg drawtext 후합성)
...
PROMPT = (
    ...
    f"YouTube thumbnail background for a children's storybook video: {MALLI} gazing up amazed with sparkling eyes "
    "as a young Korean cowherd and a graceful weaver girl in hanbok run toward each other on a long glowing bridge "
    "made of magpies and crows with linked wings, arching over a glittering Milky Way river of stars, "
    "stars swirling in celebration, magical starlight rays, wondrous romantic reunion scene, "
    "positioned on the RIGHT TWO THIRDS of the frame, bright cheerful colors with strong contrast, "
    "composition leaves the LEFT THIRD of the image relatively simple and soft (plain starry night sky) for large text overlay, "
