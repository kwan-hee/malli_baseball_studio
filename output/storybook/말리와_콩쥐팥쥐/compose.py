# 말리와 콩쥐팥쥐 — 최종 조립: 이미지 Ken Burns + 절정 클립 + 나레이션 + 자막 + BGM → MP4
import subprocess
...
VIDEO_SCENES = {
    "s04": BASE / "clips" / "s04_1080p.mp4",  # 참새 떼·검은 소 도움
    "s07": BASE / "clips" / "s07_1080p.mp4",  # 꽃신 퐁당
}
