# 말리와 콩쥐팥쥐 — 썸네일 배경 생성 (좌측 1/3 비움, 글자는 ffmpeg drawtext 후합성)
...
PROMPT = (
    ...
    "next to a kind sweet Korean girl in a jade-green silk hanbok reaching out in surprise as one pretty "
    "embroidered flower shoe (kkotsin) falls toward a sparkling clear stream with a splash beginning, "
    "stepping stones and dragonflies, magical glittering light on the water, wondrous and heartwarming scene, "
