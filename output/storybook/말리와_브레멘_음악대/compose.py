# 말리와 브레멘 음악대 — 최종 조립: 이미지 Ken Burns + Seedance 클립 + 나레이션 + 자막 + BGM → MP4
import subprocess
...
# 절정 씬 = Seedance 클립 (나머지는 정지 이미지 + Ken Burns)
VIDEO_SCENES = {
    "s08": BASE / "clips" / "s08_seedance_1080p.mp4",  # 동물 탑 + 대합창
    "s09": BASE / "clips" / "s09_seedance_1080p.mp4",  # 심술쟁이 도망
}
...
final = BASE / "말리와_브레멘_음악대_final.mp4"
