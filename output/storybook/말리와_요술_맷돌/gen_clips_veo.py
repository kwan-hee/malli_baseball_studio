# 말리와 요술 맷돌 - 절정 씬(s04 맷돌이 쏟아냄, s08 소금 산더미·배 기울기) 이미지→영상 클립 생성기
...
CLIP_PROMPTS = {
    "s04": (
        "A small round glowing stone hand-mill spins on its own and magically pours out heaps of white rice, "
        "rice cakes, colorful fruit and shiny bowls that tumble and spill out endlessly, a kind young Korean man "
        "in a beige hanbok watching with delight and wonder. "
        f"Wondrous, joyful, magical. {GHIBLI}"
    ),
    "s08": (
        "On the open blue sea a small wooden rowboat overflows with mountains of white salt pouring endlessly from "
        "a glowing stone hand-mill; the boat tilts and tips over to one side while a comical greedy thief panics "
        "with wide eyes, salt spilling into the sea. "
        f"Dramatic, frantic, funny, NOT scary. {GHIBLI}"
    ),
}
