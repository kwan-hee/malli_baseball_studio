# 말리와 요술 맷돌 — 최종 조립: 이미지 Ken Burns + 절정 클립 + 나레이션 + 자막 + BGM → MP4
...
VIDEO_SCENES = {
    "s04": BASE / "clips" / "s04_1080p.mp4",  # 맷돌이 돌며 온갖 것이 쏟아짐
    "s08": BASE / "clips" / "s08_1080p.mp4",  # 소금 산더미·배 기울기 절정
}
...
final = BASE / "✅말리와_요술_맷돌_final.mp4"  # ✅ 접두 = 폴더에서 완성본 즉시 구분
