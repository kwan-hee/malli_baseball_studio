# 말리와 요술 맷돌 — 썸네일 배경 생성 (좌측 1/3 비움, 글자는 ffmpeg drawtext 후합성)
...
PROMPT = (
    ...
    "at a small glowing magic stone hand-mill pouring endless mountains of white salt onto a tilting wooden boat "
    "on the deep blue sea, salt spilling into the ocean, wondrous surprising mood, "
