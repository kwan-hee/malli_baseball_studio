...
# s07("총각은 반가운 마음에~고맙습니다") 구간 whisper 대량 환각(129~147s)으로 접두 매칭 불가.
# 깨끗한 인접 앵커: s08 "그날부터"=156.0s, s07은 s06 종료 직후 ≈134.0s. s09·s10은 자동 재유도.
MANUAL_ANCHOR = {"s07": 134.0, "s08": 156.0}
