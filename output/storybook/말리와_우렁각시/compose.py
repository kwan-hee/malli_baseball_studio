# 말리와 우렁각시 — 최종 조립: 이미지 Ken Burns + 절정 클립 + 나레이션 + 자막 + BGM → MP4
...
VIDEO_SCENES = {
    "s04": BASE / "clips" / "s04_1080p.mp4",  # 밥상이 마법처럼 차려짐
    "s06": BASE / "clips" / "s06_1080p.mp4",  # 우렁이에서 각시가 나와 밥을 지음
}
...
final = BASE / "✅말리와_우렁각시_final.mp4"  # ✅ 접두 = 폴더에서 완성본 즉시 구분
