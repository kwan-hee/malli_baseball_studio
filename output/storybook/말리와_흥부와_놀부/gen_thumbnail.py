# 말리와 흥부와 놀부 — 썸네일 배경 생성 (좌측 1/3 비움, 글자는 ffmpeg drawtext 후합성)
...
PROMPT = (
    ...
    "as a huge pale-green gourd splits open bursting with glittering gold coins, jewels and colorful silk rolls, "
    "a cute swallow with a glossy dark-blue back flying above carrying a tiny seed, a kind Korean man in patched "
    "beige hanbok cheering with joy, magical golden sparkles everywhere, wondrous and heartwarming scene, "
    "positioned on the RIGHT TWO THIRDS of the frame, bright cheerful colors with strong contrast, "
    "composition leaves the LEFT THIRD of the image relatively simple and soft (plain warm sky) for large text overlay, "
