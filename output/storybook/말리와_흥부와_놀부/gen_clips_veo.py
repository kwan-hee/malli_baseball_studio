# 말리와 흥부와 놀부 - 절정 씬(s04 제비 박씨 귀환, s06 박 보물 폭발) 이미지→영상 클립 생성기
...
CLIP_PROMPTS = {
    "s04": (
        "A small cute swallow with a glossy dark-blue back swoops gracefully down from the blue spring sky "
        "carrying a tiny gourd seed in its beak, gliding in gentle circles toward the humble thatched cottage "
        "yard where the kind Korean family below reaches up with delighted faces, spring blossom petals "
        "drifting through the air. "
        f"Hopeful, graceful, joyful. {GHIBLI}"
    ),
    "s06": (
        "The huge pale-green gourd splits wide open with a soft burst of golden light and glittering gold "
        "coins, jewels and silk rolls spill out in a sparkling cascade, the kind Korean couple drops their "
        "saw in amazement and the two children jump and dance with joy, warm sparkles floating everywhere. "
        f"Jubilant, magical, celebratory. {GHIBLI}"
    ),
}
