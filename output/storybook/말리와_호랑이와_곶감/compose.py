# 말리와 호랑이와 곶감 — 최종 조립: 이미지 Ken Burns + Seedance 클립 + 나레이션 + 자막 + BGM → MP4
import subprocess
...
VIDEO_SCENES = {
    "s08": BASE / "clips" / "s08_seedance_1080p.mp4",
    "s09": BASE / "clips" / "s09_seedance_1080p.mp4",
}
...
final = BASE / "말리와_호랑이와_곶감_final.mp4"
