# 말리와 해와 달이 된 오누이 — 최종 조립: 이미지 Ken Burns + 절정 클립 + 나레이션 + 자막 + BGM → MP4
# 최종 출력 1280x720 (2026-07-15 규칙)
...
VIDEO_SCENES = {
    "s04": BASE / "clips" / "s04_1080p.mp4",  # 털복숭이 손 들통, 뒷문 도망
    "s07": BASE / "clips" / "s07_1080p.mp4",  # 금빛 동아줄 승천
}
...
final = BASE / "말리와_해와_달이_된_오누이_final.mp4"
