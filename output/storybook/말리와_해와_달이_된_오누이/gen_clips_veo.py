# 말리와 해와 달이 된 오누이 - 절정 씬(s04 털복숭이 손 들통, s07 동아줄 승천) 이미지→영상 클립 생성기
...
CLIP_PROMPTS = {
    "s04": (
        "Inside a warm lamplit Korean cottage at night, a big furry orange striped paw wiggles through "
        "the gap of the slightly open wooden door, the young Korean boy and his little sister stare at it "
        "with wide surprised eyes, then quietly tiptoe backward holding hands and slip out through the "
        "back door, gentle suspense with a comical touch, NOT terrifying. "
        f"Suspenseful, clever, lightly comic. {GHIBLI}"
    ),
    "s07": (
        "A glowing golden rope descends slowly from parting night clouds, the Korean boy and his little "
        "sister hold tight onto the rope and rise gently high above the treetops, their hanbok fluttering "
        "softly, stars swirling and clouds drifting past them as the dark mountains shrink far below. "
        f"Wondrous, magical, ascending climax. {GHIBLI}"
    ),
}
