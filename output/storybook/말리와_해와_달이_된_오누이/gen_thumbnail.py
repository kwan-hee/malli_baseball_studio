# 말리와 해와 달이 된 오누이 — 썸네일 배경 생성 (좌측 1/3 비움, 글자는 ffmpeg drawtext 후합성)
...
PROMPT = (
    ...
    f"YouTube thumbnail background for a children's storybook video: {MALLI} looking up amazed with sparkling eyes "
    "as a Korean boy and his little sister in hanbok hold tight onto a glowing golden rope rising into a starry "
    "night sky between parting clouds, a big comical plump tiger gazing up open-mouthed from beside a thatched "
    "cottage far below, magical golden light rays, wondrous and heartwarming scene, "
    "positioned on the RIGHT TWO THIRDS of the frame, bright cheerful colors with strong contrast, "
    "composition leaves the LEFT THIRD of the image relatively simple and soft (plain night sky with stars) for large text overlay, "
