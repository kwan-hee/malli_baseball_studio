...
# s07 "바로 그때~뎅뎅뎅" 구간 whisper 대량 환각(146~170s)으로 접두 매칭 불가.
# 깨끗한 인접 앵커로 고정: s07≈146.0(s06 종료 직후), s08=172.3("땡!" 첫 등장). s09·s10은 자동 재유도.
MANUAL_ANCHOR = {"s07": 146.0, "s08": 172.3}
