# 말리와 은혜 갚은 까치 — 썸네일 배경 생성 (좌측 1/3 비움, 글자는 ffmpeg drawtext 후합성)
...
PROMPT = (
    ...
    f"YouTube thumbnail background for a children's storybook video: {MALLI} gazing with sparkling touched eyes "
    "as a whole flock of adorable Korean magpies (kkachi) with glossy black-and-white feathers flies together to "
    "strike and ring a large glowing bronze temple bell inside an old wooden Korean bell pavilion at night, "
    "moonlight and soft sound ripples, brave heartwarming mood, "
    "positioned on the RIGHT TWO THIRDS of the frame, bright cheerful colors with strong contrast, "
    "composition leaves the LEFT THIRD of the image relatively simple and soft (plain dark night background) for large text overlay, "
