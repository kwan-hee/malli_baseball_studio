# 말리와 은혜 갚은 까치 — 최종 조립: 이미지 Ken Burns + 절정 클립 + 나레이션 + 자막 + BGM → MP4
...
VIDEO_SCENES = {
    "s04": BASE / "clips" / "s04_1080p.mp4",  # 까치 가족 감사 날갯짓
    "s07": BASE / "clips" / "s07_1080p.mp4",  # 까치들이 종을 울리는 절정
}
...
final = BASE / "말리와_은혜_갚은_까치_final.mp4"
