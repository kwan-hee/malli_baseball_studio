# 말리와 토끼와 자라 — 최종 조립: 이미지 Ken Burns + 절정 클립 + 나레이션 + 자막 + BGM → MP4
...
VIDEO_SCENES = {
    "s04": BASE / "clips" / "s04_1080p.mp4",  # 토끼를 등에 태우고 바닷속 여행
    "s06": BASE / "clips" / "s06_1080p.mp4",  # 용궁 절정 — 토끼가 꾀를 냄
}
...
final = BASE / "말리와_토끼와_자라_final.mp4"
