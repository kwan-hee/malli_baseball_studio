# 말리와 토끼와 자라 - 절정 씬(s04 바닷속 여행, s06 용궁에서 토끼가 꾀를 냄) 이미지→영상 클립 생성기
...
CLIP_PROMPTS = {
    "s04": (
        "A loyal soft-shell turtle wearing a tiny black Korean official's hat gently carries a clever "
        "wide-eyed rabbit on his back, swimming and gliding down through shimmering deep blue ocean water "
        "toward a glowing coral Dragon Palace far below, jellyfish and colorful fish drifting past, sunbeams "
        "filtering from above, the rabbit looking around in wonder. "
        f"Serene, magical, adventurous. {GHIBLI}"
    ),
    "s06": (
        "Inside a magnificent glowing underwater Dragon Palace of coral and pearl, a clever rabbit stands "
        "before a majestic kindly Korean Dragon King on his throne; the rabbit looks briefly startled then "
        "puts on a calm, sly, reassuring smile as he cleverly talks his way out of danger, the Dragon King and "
        "a turtle courtier leaning in and listening intently, shimmering blue light and drifting bubbles. "
        f"Tense then witty, dramatic, wondrous. {GHIBLI}"
    ),
}
