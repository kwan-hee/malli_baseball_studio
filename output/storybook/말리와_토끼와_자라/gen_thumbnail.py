# 말리와 토끼와 자라 — 썸네일 배경 생성 (좌측 1/3 비움, 글자는 ffmpeg drawtext 후합성)
...
PROMPT = (
    ...
    f"YouTube thumbnail background for a children's storybook video: {MALLI} gazing with sparkling excited eyes "
    "as a clever bright-eyed rabbit rides on the back of a loyal soft-shell turtle wearing a tiny Korean official's hat, "
    "swimming down through glowing deep blue ocean water toward a magnificent shimmering underwater Dragon Palace of "
    "coral and pearl, colorful fish and jellyfish drifting around, wondrous adventurous mood, "
