# 말리와 개와 고양이와 구슬 - 절정 씬(s04 강 헤엄, s07 구슬 퐁당) 이미지→영상 클립 생성기
...
CLIP_PROMPTS = {
    "s04": (
        "A dainty white cat with grey patches rides on the back of a cheerful golden-yellow dog "
        "as he swims bravely across a wide sparkling river, gentle splashes around his paws, "
        "the cat holding on with determined adorable eyes, water ripples glittering in warm daylight. "
        f"Cheerful, adventurous, heartwarming. {GHIBLI}"
    ),
    "s07": (
        "Mid-river, the white cat riding on the swimming golden dog's back opens her mouth to answer "
        "and a glowing pearl orb slips from her mouth, falling into the river with a small splash "
        "and spreading ripple rings, both animals freezing wide-eyed in comical shock, "
        f"sparkling water, dramatic but cute. {GHIBLI}"
    ),
}
