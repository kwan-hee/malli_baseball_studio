# 말리와 개와 고양이와 구슬 — 썸네일 배경 생성 (좌측 1/3 비움, 글자는 ffmpeg drawtext 후합성)
...
PROMPT = (
    ...
    f"YouTube thumbnail background for a children's storybook video: {MALLI} looking amazed with sparkling eyes, "
    "next to a cheerful golden-yellow Korean Jindo dog swimming across a sparkling river with a dainty white-and-grey cat "
    "riding on his back, a glowing golden pearl orb splashing into the water with ripple rings in front of them, "
    "magical glittering light on the water, exciting and heartwarming scene, positioned on the RIGHT TWO THIRDS of the frame, "
    "bright cheerful colors with strong contrast, "
    "composition leaves the LEFT THIRD of the image relatively simple and soft (plain sky and water) for large text overlay, "
    f"{STYLE}. "
