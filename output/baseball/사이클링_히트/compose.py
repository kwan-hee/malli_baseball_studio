# 사이클링 히트 — 최종 조립: 삽화 Ken Burns + Seedance 클립 + Puck 나레이션 + 자막 + BGM → MP4
import subprocess
...
VIDEO_SCENES = {
    "s01": BASE / "clips" / "s01_seedance20_1080p.mp4",
    "s07": BASE / "clips" / "s07_seedance20_1080p.mp4",
}
