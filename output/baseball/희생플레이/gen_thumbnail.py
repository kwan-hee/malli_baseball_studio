# 희생플레이 — 썸네일 배경 생성 (텍스트 없는 배경, 글자는 ffmpeg drawtext로 후합성)
import base64
import sys
import time
...
PROMPT = (
    ...
    "paradox baseball moment: an umpire pumping his fist in a dramatic out call in the foreground, "
    "while a cartoon batter walks away smiling proudly and his teammates lean out of the dugout clapping "
    "and cheering with sparkling warm light, a runner celebrating on second base behind them, "
    "night stadium lights, strong color contrast (deep blue night sky, warm golden glow, green field), "
    "composition leaves the RIGHT THIRD of the image relatively empty and dark for large text overlay. "
    "ABSOLUTELY NO text, NO letters, NO words, NO numbers, no real person likeness, face generic cartoon. "
