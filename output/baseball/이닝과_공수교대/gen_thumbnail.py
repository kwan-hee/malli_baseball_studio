# 이닝과 공수교대 — 썸네일 배경 생성 (텍스트 없는 배경, 글자는 ffmpeg drawtext로 후합성)
import base64
import sys
import time
...
PROMPT = (
    ...
    "a lively baseball stadium at night with a big glowing scoreboard panel (completely blank, no digits, no text), "
    "cartoon players running across the field swapping sides in a changeover, glowing directional arrows suggesting offense-defense switch, "
    "vivid warm stadium lights, strong color contrast (deep blue night sky, yellow-orange lights, green field), "
