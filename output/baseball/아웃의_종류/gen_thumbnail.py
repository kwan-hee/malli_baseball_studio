# 아웃의 종류 — 썸네일 배경 생성 (텍스트 없는 배경, 글자는 ffmpeg drawtext로 후합성)
import base64
import sys
import time
...
PROMPT = (
    ...
    "dramatic cartoon home-plate moment: a runner sliding into home plate in a burst of dust while "
    "a fielder sweeps a clearly EMPTY open glove over him, a glowing baseball lying separately on the grass nearby, "
    "night stadium lights, strong color contrast (deep blue night sky, warm dust glow, green field), "
