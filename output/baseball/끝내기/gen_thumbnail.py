# 끝내기 — 썸네일 배경 생성 (텍스트 없는 배경, 글자는 ffmpeg drawtext로 후합성)
import base64
import sys
import time
...
PROMPT = (
    ...
    "a defeated cartoon pitcher walking off the mound with his head hung low, seen from the side, "
    "while behind him a baseball flies over the outfield fence with a glowing trail and the home crowd celebrates, "
    "night stadium with vivid warm lights, strong color contrast (deep blue night sky, yellow-orange lights, red accents), "
