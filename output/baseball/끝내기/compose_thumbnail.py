# 끝내기 — 썸네일 텍스트 합성: thumb_bg.png 위에 메인/서브 문구 drawtext → thumbnail.png
import shutil
import subprocess
...
vf = (
    f"drawtext=fontfile=malgunbd.ttf:text='{MAIN}':fontsize=100:fontcolor=yellow:"
    f"borderw=7:bordercolor=black:x=w-tw-50:y=h*0.24,"
    f"drawtext=fontfile=malgunbd.ttf:text='{SUB}':fontsize=52:fontcolor=white:"
    f"borderw=5:bordercolor=black:x=w-tw-50:y=h*0.24+140"
)
