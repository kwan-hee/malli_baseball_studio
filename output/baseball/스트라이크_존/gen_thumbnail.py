# 스트라이크 존 — 썸네일 배경 생성 (텍스트 없는 배경, 글자는 ffmpeg drawtext로 후합성)
import base64
import sys
import time
...
PROMPT = (
    ...
    "dramatic cartoon home-plate moment: a glowing translucent glass box hovering above home plate with "
    "a baseball streaking through its very edge leaving a bright trail, a batter silhouette twisting to look "
    "and a crouching catcher below, night stadium lights, strong color contrast (deep blue night sky, warm glow, green field), "
