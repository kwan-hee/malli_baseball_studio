# 수비번호 — 썸네일 배경 생성 (텍스트 없는 배경, 글자는 ffmpeg drawtext로 후합성)
import base64
import sys
import time
...
PROMPT = (
    ...
    "a top-down baseball infield at a night stadium where the shortstop figure is dramatically highlighted "
    "with a bright glowing aura standing apart from the other infielders, glowing motion lines whipping "
    "the ball around the bases like a double play, vivid warm stadium lights, strong color contrast "
    "(deep blue night, yellow-orange lights, green glowing lines), "
