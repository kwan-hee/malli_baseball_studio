# 파울팁과 파울의 차이 — 썸네일 배경 생성 (텍스트 없는 배경, 글자는 ffmpeg drawtext로 후합성)
import base64
import sys
import time
...
PROMPT = (
    ...
    "dramatic closeup of a cartoon batter's bat barely grazing a glowing baseball with a bright spark "
    "and sound-wave rings at the contact point, a huge catcher's mitt wide open right behind the ball, "
    "night stadium lights, strong color contrast (deep blue night sky, warm spark glow, green field), "
